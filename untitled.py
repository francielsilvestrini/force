...
class CustomerFormScreen(Screen):
    ...
    def do_save(self):
        ...
        self.record['updated_on'] = datetime.today().strftime(Utils.datetime_format)
    ...
    def do_cancel(self):
        ...
        data = {
            ...
            'last_visit': datetime.today().strftime(Utils.date_format),
            'visit_preferably': '',
            'visit_info': '',
            'next_visit': datetime.today().strftime(Utils.date_format),            

            'syncronized_on': datetime.today().strftime(Utils.datetime_format),
            }
